...
public class CaricaElementoPage extends JFrame {
    ...
    public CaricaElementoPage(Controller controller) {
    	setIconImage(Toolkit.getDefaultToolkit().getImage(CaricaElementoPage.class.getResource("/images/UNINAFY.png")));
        ...
        gbcCaricamento.gridx = 0;
        gbcCaricamento.gridy = 0;
        gbcCaricamento.weightx = 1.0;
        gbcCaricamento.weighty = 1.0;
        gbcCaricamento.fill = GridBagConstraints.BOTH;

        pannelloCompleto.add(pannelloCaricamento, gbcCaricamento);
        ...
        gbcPulsanti.insets = new Insets(20, 0, 0, 0);
    ...
    private void caricaElemento() {
        ...
        if (id.isEmpty() || titolo.isEmpty() || descrizione.isEmpty() || copertina.isEmpty() || testoPeso.isEmpty()) {

            JOptionPane.showMessageDialog(this, "Compila tutti i campi obbligatori", "Attenzione", JOptionPane.WARNING_MESSAGE);
        ...
        try {
            ...
            if ("Audio".equals(tipo)) {
                ...
                if (risoluzione.isEmpty() || formato.isEmpty() || testoDurataVideo.isEmpty()) {
                ...
                elemento = new Video(id, descrizione, new Date(), titolo, 0,
                        copertina, risoluzione, formato, durataVideo);
            }
            ...
            JOptionPane.showMessageDialog(this, "Controlla i dati inseriti: peso e durata devono essere maggiori di zero",
