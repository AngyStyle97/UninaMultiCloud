...
public class RiproduzioneElementoPage extends JFrame {
    ...
    public RiproduzioneElementoPage(
        ...
        /*
         * Mostra il titolo dell'elemento selezionato
        ...
        btnAggiungiPlaylist.addActionListener(e -> {
            ...
            String idPlaylist = JOptionPane.showInputDialog(
                    this,
                    "Inserisci l'ID della playlist:",
            ...
            if (idPlaylist.isEmpty()) {
                ...
                JOptionPane.showMessageDialog(
                        this,
                        "Inserisci un ID playlist valido",
                        "Attenzione",
            ...
            boolean risultato =
                    controller.aggiungiElementoAPlaylist(
            ...
            if (risultato) {
                ...
                JOptionPane.showMessageDialog(
                        this,
                        "Elemento aggiunto alla playlist"
                );
                ...
                JOptionPane.showMessageDialog(
                        this,
                        "Impossibile aggiungere l'elemento alla playlist",
                        "Errore",
